...
function preload() {
  plant = loadImage("assets/pictures/powerplant.png");
  Fplant = loadImage("assets/pictures/powerplan't.png");
  causes = loadTable("assets/tables/causes.csv", "ssv",  "header");
  energyMort = loadTable("assets/tables/energyMort.csv", "ssv", "header");
geiger = loadSound("assets/sounds/geiger.mp3");
  slurp = loadSound("assets/sounds/slurp.mp3");
  biem = loadSound("assets/sounds/bakeretsu.mp3");
  succes = loadSound("assets/sounds/succes.mp3");
}
